...
const projects = [
  ...
  {
    title: "jewellery shop landing page",
    description:
      "A comprehensive IoT dashboard for monitoring and controlling smart devices with real-time data visualization and automated alert systems.",
    image: "/jewe1.jpg",
    technologies: ["React", "javascript"],
    features: ["animations ", "responsive", "send the interest"],
    liveUrl: "#",
    githubUrl: "#",
    status: "Completed",
    duration: "2 days",
